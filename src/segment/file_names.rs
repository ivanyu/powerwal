...
pub(super) fn log_file_name(base_offset: u64) -> String {
    return format!("{:0>20}.log", base_offset);
}

pub(super) fn get_base_offset_from_segment_log_file_name(file_name: OsString) -> Option<u64> {
...
#[cfg(test)]
mod tests {
    use crate::segment::file_names::{get_base_offset_from_segment_log_file_name, log_file_name};
    use rstest::rstest;
    use std::ffi::OsString;
